...
export interface NativeProps extends ViewProps {
    ...
    outputFormat?: CodegenTypes.WithDefault<'m4a' | 'aac' | 'wav' | 'opus', 'm4a'>;
    ...
    recordingMode?: CodegenTypes.WithDefault<'scroll' | 'morph' | 'centered', 'scroll'>;
    futureBarStyle?: CodegenTypes.WithDefault<'dot' | 'line' | 'hidden', 'hidden'>;
     ...
     */
    controlledState?: CodegenTypes.WithDefault<'auto' | 'idle' | 'recording' | 'paused' | 'preview' | 'stopped', 'auto'>;
...
interface NativeCommands {
    ...
    seekPreview: (viewRef: React.ElementRef<HostComponent<NativeProps>>, positionMs: CodegenTypes.Int32) => void;
}
