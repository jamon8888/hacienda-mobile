      ...
      <ScrollView
        ...
        <View className="w-full flex flex-col" style={{ gap: 12 }}>
          ...
          <Text style={{ color: "#9F9FA0" }} className="text-xs">
            ...
            audio, images, and 100+ formats via Xberg.
          </Text>
        </View>
        ...
        <View className="w-full flex flex-col" style={{ gap: 12 }}>
          ...
          <Text style={{ color: "#9F9FA0" }} className="text-xs">
            Xberg processes 100+ file formats on-device. Audio files are
            transcribed with Whisper. Images are OCR'd with Tesseract.
          </Text>
        </View>
