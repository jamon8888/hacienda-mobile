      ...
      routes: [
        {
          ...
          params: {
            ...
            threadSlug: initialThreadSlug ?? workspace.threads?.[0]?.slug,
          },
        },
      ],
    });
      ...
      <ScrollView
        ...
        <View className="w-full flex flex-col" style={{ gap: 12 }}>
          ...
          <TouchableOpacity
            style={{ backgroundColor: "#27282A", padding: 14, gap: 20 }}
            className="w-full flex flex-row items-center rounded-lg"
            onPress={() => goToPage("system_prompt")}>
            <View className="flex flex-row gap-2 items-center">
          ...
          <Text style={{ color: "#9F9FA0" }} className="text-xs">
            The system prompt is the guiding prompt and instructions for the AI.
            It should be used to guide the AI's behavior and type of responses.
          </Text>
        </View>
        ...
        <View className="w-full flex flex-col" style={{ gap: 12 }}>
          ...
          <Text style={{ color: "#9F9FA0" }} className="text-xs">
            The temperature is the level of randomness of the AI's responses.
            The higher the temperature, the more random the responses will be.
          </Text>
        </View>
        ...
        <View className="w-full flex flex-col" style={{ gap: 12 }}>
          ...
          <Text style={{ color: "#9F9FA0" }} className="text-xs">
            The context length is the maximum number of tokens that the AI can
            use to while generating a response.
          </Text>
        </View>
        ...
        <View className="w-full flex flex-col" style={{ gap: 12 }}>
          ...
          <TouchableOpacity
            style={{ backgroundColor: "#27282A", padding: 14, gap: 20 }}
            className="w-full flex flex-row items-center rounded-lg"
            onPress={() => goToPage("embedding")}>
            <View className="flex flex-row gap-2 items-center">
              <Globe size={18} color="#FFF" />
              <Text className="text-white text-lg">Embedding</Text>
            </View>
            <View className="flex flex-1 flex-row gap-2 items-center justify-between">
              <Text
                numberOfLines={1}
          ...
          <Text style={{ color: "#9F9FA0" }} className="text-xs">
            Configure embedding model, dimensions, and language detection for
            document search.
          </Text>
        </View>
        ...
        <View className="w-full flex flex-col" style={{ gap: 12 }}>
          ...
          <Text style={{ color: "#9F9FA0" }} className="text-xs">
            Import and manage documents for this workspace. Supports PDF, DOCX,
            audio, and 100+ formats via Xberg.
          </Text>
        </View>
        ...
        <View className="w-full flex flex-col" style={{ gap: 12 }}>
          ...
          <TouchableOpacity
            style={{ backgroundColor: "#27282A", padding: 14, gap: 20 }}
            className="w-full flex flex-row items-center rounded-lg"
            onPress={askToResetVectorsForWorkspace}>
            <View className="flex flex-row gap-2 items-center">
          ...
          <Text style={{ color: "#9F9FA0" }} className="text-xs">
            This is the number of vectors that are currently stored in the
            workspace. This is used to store the context of the workspace.
          </Text>
        </View>
