...
Conclusion: **the wins are (1) indexing throughput, (2) query-time *skip/widen* routing, (3) context budget, (4) precision.** Pure search speed is NOT the problem at folder scale.
...
*Owners: VDB + Embedder (A2/A3/C1), Needle (B1), provider layer (B3/C2/C3), Document model + migrations (A1/C3).*
