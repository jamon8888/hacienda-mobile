...
*Reviewer: this plan merges the prior docs into one dependency-ordered, revert-safe sequence; the biggest code-accurate correction is that folder import is currently only a stub, making P1 more foundational than the earlier X-speed doc implied.*