...
export interface UseXbergReturn {
  extractFile: (filePath: string, config?: ExtractionConfig) => Promise<ExtractionResult | null>;
  extractBatch: (filePaths: string[], config?: ExtractionConfig) => Promise<ExtractionResult | null>;
